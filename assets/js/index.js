...
var tooltip = d3.select("body")
    ...
    .attr("class", "tooltip")
    .style("opacity", 0)
    .html('<i class="fa fa-times"></i> <br/><a href="#">Informazioni generiche per anno <span class="year"></span> </a><hr/><a href="#">Informazioni specifiche <span class="status"></span> per anno <span class="year"></span> </a><hr/><a href="#">Informazioni generiche <span class="status"></span> </a>');
...
d3.csv("data/index.csv", function (error, data) {
